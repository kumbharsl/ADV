  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        // GetPage(name: '/page9', page: () => Page9()),
        // GetPage(name: '/page10', page: () => Page10()),
        // GetPage(name: '/page11', page: () => Page11()),
        // GetPage(name: '/page12', page: () => Page12()),
        // GetPage(name: '/page13', page: () => Page13()),
        // GetPage(name: '/page14', page: () => Page14()),
        // GetPage(name: '/page15', page: () => Page15()),
        // GetPage(name: '/page16', page: () => Page16()),
        // GetPage(name: '/page17', page: () => Page17()),
        // GetPage(name: '/page18', page: () => Page18()),
      ],
    );
  }
}
